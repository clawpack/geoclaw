...
#------------------------------
    ...
    domain_extent = (-190, -60, -60, 0)
    x_west, x_east, y_south, y_north = domain_extent  # unpack

    # Lower and upper edge of computational domain:
    clawdata.lower[0] = x_west       # west longitude
    clawdata.upper[0] = x_east       # east longitude

    clawdata.lower[1] = y_south       # south latitude
    clawdata.upper[1] = y_north       # north latitude
    ...
    # read directly from THREDDS server: (does not work)
    #topo_path = 'https://www.ngdc.noaa.gov/thredds/dodsC/global/ETOPO2022/30s/30s_bed_elev_netcdf/ETOPO_2022_v1_30s_N90W180_bed.nc'

    # use global GEBCO 30 arcsecond data in local file:
    topo_path = '/Users/rjl/git/AGTwork/topo/GEBCO_2026.nc'
    topo = topotools.Topography()
    topo.path = topo_path
    topo.topo_type = 4  # netCDF
    topo.crop_extent = domain_extent  # computational domain
