...
#------------------------------
    ...
    clawdata.upper[0] =  126.e3       # xupper
    clawdata.lower[1] =    0.         # ylower
    clawdata.upper[1] =  126.e3       # yupper
    
    # Number of grid cells:
    clawdata.num_cells[0] = 63      # mx
    clawdata.num_cells[1] = 63      # my
    ...
    amrdata.refinement_ratios_x = [4,5,10,2]
    amrdata.refinement_ratios_y = [4,5,10,2]
    amrdata.refinement_ratios_t = [4,5,10,2]
    ...
    if 1:
        regions.append([1, 1, 0., 1e9, -130e3,130e3,-130e3,130e3])   # domain
        regions.append([1, 2, 0., 1000, -130e3,130e3,-130e3,130e3])   # domain
        regions.append([3, 3, 0., 150., 0e3, 40e3, 0e3, 40e3])  # around origin

        regions.append([1, 3, 0., 1e9, 50e3, 100e3, 50e3, 100e3]) 
        #regions.append([1, 4, 0., 1e9, 77e3, 90e3, 77e3, 90e3]) 
        #regions.append([1, 4, 0., 1e9, 75e3, 82e3, 75e3, 82e3])
        
        regions.append([1, 4, 0, 1900., 72e3, 77e3, 72e3, 77e3])
        regions.append([1, 5, 0, 2100., 76e3, 80e3, 76e3, 80e3])
        regions.append([1, 5, 0, 2300., 78e3, 82e3, 78e3, 82e3])
        regions.append([1, 5, 0, 2500., 80e3, 84e3, 80e3, 84e3])
        regions.append([1, 4, 0, 1e9, 82e3, 88e3, 82e3, 88e3])
        regions.append([1, 5, 0, 1e9, 82e3, 84.5e3, 82e3, 84.5e3])

    if 0:
        # try more refinement:
        regions.append([1, 5, 0, 1e9, -130e3,130e3,-130e3,130e3])   #whole domain
...
#-------------------
    ...
    topofiles.append([2, 1, 1, 0., 1.e10, 'ocean.topotype2'])
    #topofiles.append([1, 1, 1, 0., 1.e10, 'flat_4000.tt1'])
