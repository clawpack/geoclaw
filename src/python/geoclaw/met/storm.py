...
1. Create a `Storm` object by reading in from a file::
    ...
    storm = clawpack.geoclaw.met.storm.Storm("my_storm.txt", file_format='ATCF')
...
:Object model:
    ...
    :class:`~clawpack.geoclaw.met.track.StormTrack`,
    :class:`~clawpack.geoclaw.met.parametric.ParametricMetForcing`, and
    :class:`~clawpack.geoclaw.met.gridded.GriddedMetForcing`.  Every legacy
...
class Storm(object):
    ...
    :class:`~clawpack.geoclaw.met.track.StormTrack` (plus a
    :class:`~clawpack.geoclaw.met.parametric.ParametricMetForcing` for the
    parameterized/track path) and a
    :class:`~clawpack.geoclaw.met.gridded.GriddedMetForcing` for the gridded
