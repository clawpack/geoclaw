...
from clawpack.geoclaw.met.track import _Meta
...
class GriddedMetForcing(object):
    ...
    # in :class:`~clawpack.geoclaw.met.data_storms.OWIData`, and the forcing
    ...
    def to_owi(self, data, pressure_path, wind_path):
        ...
        :Input:
         - *data* (:class:`~clawpack.geoclaw.met.data_storms.OWIData`) fields.
