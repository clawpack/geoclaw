...
c      #  ok as long as meqn, mwaves < maxvar
       ...
       dimension ql(max1dp1,nvar),    qr(max1dp1,nvar)
       dimension wave(max1dp1,nvar,mwaves), s(max1dp1,mwaves)
       dimension amdq(max1dp1,nvar),  apdq(max1dp1,nvar)
...
c                # from the cell corresponding  to q
  ...
  5          continue
       ...
       do 10 ivar = 1, nvar
         ql(j-nghost+1,ivar) = valbig(ivar,nghost,j)
 10    continue
   ...
   24          continue
         ...
         do 25 ivar = 1, nvar
 25         qr(lind,ivar) = qc1d(ivar,index)
 20    continue
       index = ncrse
...
c          # skip over sides 2 and 4 in this case
 ...
 205         continue
        ...
        do 210 ivar = 1, nvar
            qr(i-nghost,ivar) = valbig(ivar,i,mjtot-nghost+1)
 210    continue
...
c                # preserves conservation in incompressible flow:
  ...
  224          continue
         ...
         do 225 ivar = 1, nvar
 225         ql(lind+1,ivar) = qc1d(ivar,index)
 220    continue
...
c
 ...
 305         continue
        ...
        do 310 ivar = 1, nvar
          qr(j-nghost,ivar) = valbig(ivar,mitot-nghost+1,j)
 310      continue
...
c                # preserves conservation in incompressible flow:
  ...
  324          continue
         ...
         do 325 ivar = 1, nvar
 325         ql(lind+1,ivar) = qc1d(ivar,index)
 320    continue
...
c                # preserves conservation in incompressible flow:
 ...
 405         continue
        ...
        do 410 ivar = 1, nvar
          ql(i-nghost+1,ivar) = valbig(ivar,i,nghost)
 410      continue
  ...
  424          continue
         ...
         do 425 ivar = 1, nvar
 425         qr(lind,ivar) = qc1d(ivar,index)
 420    continue
