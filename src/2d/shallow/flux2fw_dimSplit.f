...
c--------------------------flux2fw_geo.f--------------------------
c     This version of flux2fw_dimSPlit.f is modified slightly to be used with
c     step2.f  The only modification is for the first-order
...
c
   ...
   20   continue
      ...
      do i = 1-mbc, mx+mbc
          if (q1d(1, i) .lt. 0.d0) then
              print *,"h in flux2fw is negative. h = ", q1d(1,i)
              print *,"ixy = ", ixy
          endif
      enddo
c
