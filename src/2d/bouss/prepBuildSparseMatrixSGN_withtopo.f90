subroutine prepBuildSparseMatrixSGN(soln,rhs,nvar,naux,levelBouss,numBoussCells)
...
! ================== Step 2  set up for matrix elements  ======================
    ...
    nng_loop: do  nng = 1, numgrids(levelBouss)
        ...
        call cleanBuildSparseMatrixSGN_withtopo(alloc(loc),alloc(locold),       &
...
end subroutine prepBuildSparseMatrixSGN
