...
#------------------------------
    ...
    clawdata.lower[0] = -9.0      # west longitude
    clawdata.upper[0] = 9.0      # east longitude

    clawdata.lower[1] = 11.0       # south latitude
    clawdata.upper[1] = 19.0      # north latitude
...
#-------------------
    ...
    topo_data.topofiles.append([3, 1, 5, rundata.clawdata.t0, rundata.clawdata.tfinal, 
                                os.path.join(os.getcwd(), 'test-bathy.asc')])
    ...
    data.landfall = days2seconds(storm_landfall.days) + storm_landfall.seconds
    data.storm_file = os.path.expandvars(os.path.join(os.getcwd(),'test-'))
