...
class IsaacTest(test.GeoClawRegressionTest):

    r"""Hurricane Isaac data derived regression test"""

    def setUp(self):

        super(IsaacTest, self).setUp()
        ...
        # storm_path = os.path.join(os.path.dirname(path), 'isaac.info')
    ...
    def check_gauges(self, save=False, gauge_id=1, indices=(2, 3)):
        ...
        # Get gauge data
        data = numpy.loadtxt(os.path.join(self.temp_path, 'gauge00001.txt'))
        data_sum = []
